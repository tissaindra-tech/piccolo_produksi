  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '16px' }}>
        ...
        <BigBtn color="blue" icon="📋" label="Update Stok" onClick={() => setView('closing')} />
    ...
    if (type === 'stok') {
      ...
      closing.forEach(c => {
        ...
        data.push({
          ...
          Kategori: b?.kategori || '-', Divisi: b?.divisi || '-', Satuan: b?.satuan_dasar || '-',
          'Stok Sebelum': c.prediksi_sistem,
          'Stok Aktual': c.sisa_aktual,
          'Selisih': selisih,
          'Naik/Turun': selisih > 0 ? 'Naik' : selisih < 0 ? 'Turun' : 'Sama',
          'Yang Update': c.yang_closing || '-',
          Catatan: c.catatan || '',
        })
      })
      filename = `History_Stok_Piccolo_${formatTanggal()}.xlsx`
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '8px' }}>
        ...
        <button onClick={() => exportExcel('closing')} style={{ ...S.btn, ...S.btnSecondary, fontSize: '11px', padding: '10px' }}>📥 Export History Stok</button>
