    ...
    return (
      <div>
        <button onClick={() => setSelected(null)}
          style={{ ...S.btn, ...S.btnSecondary, fontSize: '12px', marginBottom: '14px', padding: '7px 12px' }}>
          ← Kembali
        </button>
        ...
        {selected.foto_nota && (
          <div style={{ marginTop: '4px' }}>
            ...
            <img
              src={selected.foto_nota} alt="foto nota"
              onClick={() => setFotoModal(selected.foto_nota)}
