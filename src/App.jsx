    ...
    <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ background: C.panel, borderRadius: '16px', padding: '32px 24px', maxWidth: '380px', width: '100%', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
        ...
        <div style={{ marginTop: '20px', fontSize: '11px', color: C.text3, textAlign: 'center', lineHeight: 1.6 }}>
          PIN Staff · Purchasing · Owner<br />Hubungi owner jika lupa PIN
        </div>
      </div>
    </div>
  )
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', color: C.text2 }}>
...
function AppShell(props) {
  ...
  return (
    <div style={{ maxWidth: '440px', margin: '0 auto', minHeight: '100vh' }}>
      ...
      {isLocked && (
        <div style={{ background: C.redBg, padding: '10px 18px', borderBottom: `1px solid ${C.redBorder}` }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px', padding: '10px', background: C.panel2, overflowX: 'auto' }}>
        {tabs[role].map(t => (
          <button key={t.id} onClick={() => setView(t.id)} style={{
            padding: '7px 11px', fontSize: '11px', border: 'none',
